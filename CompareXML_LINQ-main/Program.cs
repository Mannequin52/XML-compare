...
namespace UsporediXML_LINQ
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            XDocument xml1 = XDocument.Load(@"C:\Users\Anastasija\Downloads\2XML\CompareXML_LINQ-main\prvi.xml");
            XDocument xml2 = XDocument.Load(@"C:\Users\Anastasija\Downloads\2XML\CompareXML_LINQ-main\drugi.xml");
